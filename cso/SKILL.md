...
```json
{
  ...
  "lifecycle_integrity": [{
    "area": "subscription | account",
    "severity_business": "CRITICAL | HIGH | MEDIUM | LOW",
    "title": "...",
    "what_happens": "concrete user-facing consequence, step by step",
    "file": "file:line or 'absent — no such code'",
    "fix": "..."
  }],
